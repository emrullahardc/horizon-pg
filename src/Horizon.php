...
class Horizon
{
    ...
    /**
     * Configure the database connection that will store Horizon data.
     *
    ...
    {
        // For PostgreSQL-based Horizon, the connection is configured via
        // the 'horizon.database_connection' config key. This method is
        // kept for backward compatibility with the Horizon API.
    }
