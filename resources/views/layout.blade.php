...
<head>
    ...
    {{ HorizonPg\Horizon::css() }}
    {{ HorizonPg\Horizon::js() }}
</head>
            ...
            <div class="d-flex align-items-center py-4 header">
                <router-link to="/" class="logo d-flex align-items-center">
                    ...
                    <h1 class="h4 mb-0 ms-2">
                        ...
                        Horizon{{ config('horizon.name') ? ' - ' . config('horizon.name') : '' }}
                    </h1>
                </router-link>
                ...
                <div class="ms-auto">
                    ...
                    <button class="btn btn-muted ms-2" :class="{active: autoLoadsNewEntries}"
                        v-on:click.prevent="autoLoadNewEntries" title="Auto Load New Entries">
                ...
                <div class="col-10">
                    @if ($isDownForMaintenance)
                        <div class="alert alert-warning">
                            This application is in "maintenance mode". Queued jobs may not be processed unless your worker
                            is using the "force" flag.
                        </div>
                    @endif
